...
enum ReaderTextSpacing: String, CaseIterable, Identifiable, Sendable {
    ...
    /// ⚠️ CRITICAL: DO NOT MODIFY THESE VALUES WITHOUT EXPLICIT AUTHORIZATION.
    /// These multipliers are precisely tuned to align with AppKit's text rendering engine.
    /// Non-intended changes (e.g., "vibe coding" optimizations) will break background highlight
    /// alignment.
    /// WARN THE USER BEFORE ANY MODIFICATIONS
    ///
